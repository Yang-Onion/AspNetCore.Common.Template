...
namespace AspNetCore.Common.Services.Identity.Impl
{
    public class MenuService : IMenu
    {
        ...
        //{
        //    return _menuRepository.FirstOrDefaultAsync(x => x.Id == menuId);
        //}

        //public Menu GetMenuById(int menuId)
        //{
        //    return _menuRepository.FirstOrDefault(x => x.Id == menuId);
        //}
        ...
        //{
        //    //var menu = _menuRepository.Where(t => t.Id == model.Id).FirstOrDefault();
        //    //menu.Name = model.Name;
        //    //menu.Sequence = model.Sequence;
        //    //menu.Value = model.Value;
        ...
        //{
        //    var menu = _menuRepository.FirstOrDefault(t => t.Id == int.Parse(id));
